# 1 "/tmp/tmpja10f1b6"
#include <Arduino.h>
# 1 "/home/ubuntu/src/pn532/Bolty/src/bolty.ino"
# 21 "/home/ubuntu/src/pn532/Bolty/src/bolty.ino"
#include <Arduino.h>
#include "bolt.h"
...
void loop(void);
#line 185 "/home/ubuntu/src/pn532/Bolty/src/bolty.ino"
static void reset_card_assessment(CardAssessment &assessment) {
...
struct sAppHandler {
  String app_title;
  String app_desc;
  tAppHandler app_start;
  tAppHandler app_end;
  tAppHandler app_loop;
...
# 449 "/home/ubuntu/src/pn532/Bolty/src/bolty.ino"
...
# 527 "/home/ubuntu/src/pn532/Bolty/src/bolty.ino"
void loadBoltConfig(uint8_t slot) {
  char path[20];
  sprintf(path, "/config%02x.dat", slot);
  SPIFFS.begin(true);
...
void setup(void) {
  ...
  server.on("/qr", HTTP_GET, [](AsyncWebServerRequest *request) {
    ...
    response->print(
        ...
        "DejaVuSansMonoBold,monospace;font-size: 0.2em;'>");
...
# 2036 "/home/ubuntu/src/pn532/Bolty/src/bolty.ino"
    else if (cmd == "ndef") {
     if (!bolty_hw_ready) { Serial.println(F("[error] NFC not ready")); return; }
...
# 2465 "/home/ubuntu/src/pn532/Bolty/src/bolty.ino"
