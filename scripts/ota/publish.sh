#!/usr/bin/env bash
# publish.sh — Build OTA firmware and publish to scripts/ota/
#
# Usage:
#   cd Bolty
...
#
# What it does:
#   1. Builds esp32dev-ota environment
#   2. Copies firmware.bin to scripts/ota/firmware-<version_code>.bin
#   3. Reads FW_VERSION_CODE from the generated build_metadata.h
#   4. Writes/updates scripts/ota/manifest.json
#
# The serve.py script can then be started to serve the update.
